...
public class CardManagerWindow {
    ...
    private JProgressBar progressBarGelernt;
    ...
    public void updateTextArea() {
        ...
        // Update progress bar
        progressBarGelernt.setMinimum(0);
        progressBarGelernt.setMaximum(totalKarten);
        progressBarGelernt.setValue(totalGelernt);
        progressBarGelernt.setString("Gelernt: " + totalGelernt + "/" + totalKarten);
        progressBarGelernt.setStringPainted(true);
    }
