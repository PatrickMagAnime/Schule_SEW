...
public class _2GUIMultipleFunctions extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        // Es kann natürlich für alles eigene Methoden geschrieben werden, diese müssen jedoch in paintComponent aufgerufen werden. Ansonsten wird es nicht gezeichnet
        drawText(g);
        drawLine(g);
        drawRectangle(g);
        drawOval(g);
